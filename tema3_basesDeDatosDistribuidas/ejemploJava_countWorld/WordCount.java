...
public class WordCount {
  ...
  /**
   * El mapper extiende de la interfaz org.apache.hadoop.mapreduce.Mapper. Cuando se ejecuta Hadoop,
   * el mapper recibe cada linea del archivo de entrada como argumento. La función "map" parte cada línea
   * y para cada palabra emite la pareja (word,1) como salida.
   */
  ...
  /**
   * La función "reduce" recibe los valores (apariciones) asociados a la misma clave (palabra) como entrada y produce
   * una pareja con la palabra y el número total de apariciones. como las parejas generadas por la función "map" siempre
   * tienen como valor 1 se podría evitar la suma y devolver directamente el número de elementos.  
   */
